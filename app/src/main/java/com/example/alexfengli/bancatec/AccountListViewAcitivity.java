        ...
        service.getService().getAccountsClient(user, new Callback<List<AccountDTO>>() {
            ...
            public void success(List<AccountDTO> accountDTOs, Response response) {
                ...
                for(int i = 0; i< accountDTOs.size();i++)
                {
                    ...
                    temp.put("first",accountDTOs.get(i).numeroCuenta);
                    if(accountDTOs.get(i).tipoCuenta)
                    {
                    ...
                    if(accountDTOs.get(i).endolares)
                    {
                    ...
                    else
                    {
                     ...
                     temp.put("fourth",String.valueOf(accountDTOs.get(i).saldo));
                    accounts.add(temp);
                }
